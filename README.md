...
- `빅오 표기법`(빠른 순)
    ...
    - $O(n)$ : 단순 for문
    - $O(n log n)$ : 이중 for문인데 안쪽 부분이 전체 중 일부만 처리
    - $O(n^2)$ : 이중 for문
    - $O(n^3)$ : 삼중 for문
    - $O(2^n)$ : 팩토리얼 등등...
...
- 자료구조
    - 연결리스트
        ...
        - 파이썬 list(): 연결리스트와 유사
        - 연결 리스트 실습 : 주소록[파이썬](./day03/makeSimpleLinkedList.py)
...
https://github.com/user-attachments/assets/53e3ec5a-025f-446f-853d-e4ba6435c40d
